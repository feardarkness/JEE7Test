...
function agregarYDibujarInterfazDeMensajes(mensajeChat) {    
    ...
    contenidoChat += "<p>[<em><small>" + mensajeChat.fechaRecepcion + "</small></em>] <strong>" + mensajeChat.usuario + "</strong>: " + mensajeChat.mensaje+"</p>";
    $divChat.html(contenidoChat).appendTo($divChatContenedor);        
    $("#contenedor-chat").animate({scrollTop: $("#contenedor-chat").height()}, 1000);
}
...
$(document).ready(function () {    
    ...
    $("#enviar").on("click", function (e) {
        e.preventDefault();
        // OJO, por buena practica, varias inicializaciones deberían ir separadas por comas
        var mensaje = $("#mensaje").val();
        var fechaMensaje = moment().format("DD/MM/YYYY HH:mm:ss");
        var mensajeChat = new MensajeChat(mensaje, "Usuario 1", fechaMensaje, "default");
        agregarYDibujarInterfazDeMensajes(mensajeChat);
