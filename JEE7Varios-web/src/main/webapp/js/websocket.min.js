...
function agregarYDibujarInterfazDeMensajes(mensajeChat) {
    ...
    contenidoChat += "<p>[<i><small>" + mensajeChat.fechaRecepcion + "</small></i>] <strong>" + mensajeChat.usuario + "</strong>: " + emoticon.agregarEmoticones(mensajeChat.mensaje) + "</p>";
...
$(document).ready(function () {
    ...
    $("#enviar").on("click", function (e) {
        e.preventDefault();
        // OJO, por buena practica, varias inicializaciones deberían ir separadas por comas, no con un var para cada una
